...
const larkClientCtorMock = vi.hoisted(() =>
  vi.fn(function LarkClientCtor() {
    return {};
  }),
);

const eventDispatcherCtorMock = vi.hoisted(() =>
  vi.fn(function EventDispatcherCtor() {
    return {};
  }),
);
...
vi.mock("@larksuiteoapi/node-sdk", () => ({
  ...
  Client: larkClientCtorMock,
  WSClient: wsClientCtorMock,
  EventDispatcher: eventDispatcherCtorMock,
